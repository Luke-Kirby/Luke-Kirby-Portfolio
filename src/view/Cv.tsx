          ...
          <div className="timescale-content">
            ...
            >
              ...
              >
                ...
                web development (using online tools such as Codecademy) with
                JavaScript and TypeScript (with React), Git, HTML and CSS.
              </p>
            </div>
            ...
            <div className="block-text">
              <p>
                ...
                working with other engineers, data scientists and data analysts
                to conduct integrity assessments / calculations and produce
                detailed technical reports for clients. Job role consisted of:
              </p>
              <ul>
                <li>
                  Programming with VBA to develop in-house macros for integrity
                  assessment calculations. I led the development for ROSEN's
                  official in-house “Lamination Screening Assessment” macros
                  against industry recognised standards.
                </li>
                <li>
                  Use of CAD, FEA, Excel and other in-house software / macros to
                  conduct the relevant calculations and assessments. The
                  assessments determined the condition of the pipeline(s)
                  integrity and the results were reported to clients.
                </li>
                <li>
                  QA of level 1 engineering calculations, integrity assessments
            ...
            <div className="block-text">
              ...
              <ul>
                <li>Computational Modelling (including MATLAB, CAD and FEA)</li>
                <li>Robotics</li>
              ...
              <p style={{ marginLeft: "20px" }}>
                ...
                experiment-based project that involved using imaging, mechanical
                and thermal inspection methods within the university's
                laboratories. Other companies I have visited or completed
                projects for as a part of work experience modules include
                Caterpillar, British Engines, Siemens and PDL Solutions.
              </p>
            </div>
            <BulletPoint
              time="2017"
            ...
            <div className="block-text">
              ...
              <p style={{ marginLeft: "20px" }}>
                I completed a project for the company DeepOcean, who operate in
                the oil and gas sector. Working closely with this client, I have
                produced many design-based deliverables for DeepOcean, such as
                product designs, CAD / FEA models and drawings, costings,
                operational storyboards, ship deck layout drawings, experimental
                prototypes, risk assessment and hazard identification documents.
              </p>
            </div>
            <BulletPoint
              time="2014"
